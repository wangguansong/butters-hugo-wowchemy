...
{{< math >}}
$$G(x) = \operatorname{sign}
\left( \sum_{m=1}^M \alpha_m G_m(x) \right) \tag{10.1}$$
{{< /math >}}

其中的 $\alpha_1$、$\alpha_2$、……、$\alpha_M$ 从提升算法的过程中得出，并被用作每个相应的分类器 $G_m(x)$ 在投票中的权重。它们的作用是在最终投票中，给予序列中更准确的分类器更高的权重。[图10.1](#figure-f1001) 展示了自适应提升的示意图。
...
[算法 10.1](#算法-101自适应提升-m1) 详细说明了自适应提升 M1 算法。步骤（2.1）在加权的样本上训练当前的分类器 $G_m(x)$。步骤（2.2）计算所得的加权错误率。步骤（2.3）计算分类器 $G_m(x)$ 在最终的分类结果 $G(x)$ 中（第 3 行）所占的权重 $\alpha_m$。步骤（2.4）更新下一步迭代的每个样本权重。$G_m(x)$ 误分类的样本的权重会放大到 $exp(\alpha_m)$ 倍，相对地增加了它们对迭代下一步中的分类器 $G_{m+1}(x)$ 的影响力。
...
- 练习 10.1：[第 10.4 节]({{< relref "../ch10/ch10_04.md#练习-101" >}})
- 练习 10.2：[第 10.5 节]({{< relref "../ch10/ch10_05.md#练习-102" >}})
- 练习 10.3：[第 10.13 节]({{< relref "../ch10/ch10_13.md#练习-103" >}})
- 练习 10.4：[第 10.4 节]({{< relref "../ch10/ch10_04.md#练习-104" >}})
- 练习 10.5：[第 10.6 节]({{< relref "../ch10/ch10_06.md#练习-105" >}})
- 练习 10.6：[第 10.8 节]({{< relref "../ch10/ch10_08.md#练习-106" >}})
- 练习 10.7：[第 10.9 节]({{< relref "../ch10/ch10_09.md#练习-107" >}})
- 练习 10.8：
- 练习 10.9：[第 10.10 节]({{< relref "../ch10/ch10_10.md#练习-109" >}})
- 练习 10.10：[第 10.10 节]({{< relref "../ch10/ch10_10.md#练习-1010" >}})
- 练习 10.11：[第 10.13 节]({{< relref "../ch10/ch10_13.md#练习-1011" >}})
- 练习 10.12：[第 10.13 节]({{< relref "../ch10/ch10_13.md#练习-1012" >}})
